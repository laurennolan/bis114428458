...
body {
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-inverse">
      ...
      <li>
      <div class="dropdown">
        <button class="dropbtn"><a href="maps.php">Eat Out</button>
        <div class="dropdown-content">
            <a href="searchMap.html">Map</a>
            <a href="rating.php">Ratings</a>
            <a href="insertrestaurant.php">Add New Restaurant </a>
            <a href="maps.php">Cork City</a>
            <a href="dublinMap.php">Dublin City</a>
            <a href="galwayMap.php">Galway City</a>
            <a href="limerickMap.php">Limerick City</a>
            <a href="belfastMap.htphpml">Belfast City</a>
        </div>
      </div>
      </li>
      <li>
    ...
    <script>
      var customLabel = {
        ...
        var map = new google.maps.Map(document.getElementById('map'), {
          center: new google.maps.LatLng(53.2707, -9.0568),
          zoom: 13
        });
